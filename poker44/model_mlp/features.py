...
Behavioral, hero-centric features per hand. Hole/board cards are obfuscated in
the benchmark, so all signal comes from hero actions, bet sizings (bb), pot
geometry, street depth, aggression and fold/continuation tendencies.
"""
...
class HandFeatureExtractor:
    ...
    def extract(self, hand: dict) -> List[float]:
        ...
        hero_actions = [a for a in actions if a and a.get("actor_seat") == hero_seat]
